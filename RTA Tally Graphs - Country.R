...
colnames(premelt)
Country_Data  <- premelt[,c(3,8,10:54)]
...
tiff("C:/Users/falk/Google Drive/PhD/PhD Projects/Blue Steel/Paper#2/Root Angles/RTA_Country_Day6.tiff", units = "in" ,height = 8, width = 14, res=200)
...
tiff("C:/Users/falk/Google Drive/PhD/PhD Projects/Blue Steel/Paper#2/Root Angles/RTA_Country_Day9.tiff", units = "in" ,height = 8, width = 14, res=200)
...
tiff("C:/Users/falk/Google Drive/PhD/PhD Projects/Blue Steel/Paper#2/Root Angles/RTA_Country_Day12.tiff", units = "in" ,height = 8, width = 14, res=200)
